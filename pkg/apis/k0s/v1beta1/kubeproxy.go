...
// @see https://github.com/kubernetes/kube-proxy/blob/v0.31.0-alpha.1/config/v1alpha1/types.go#L27-L48
...
// @see https://github.com/kubernetes/kube-proxy/blob/v0.31.0-alpha.1/config/v1alpha1/types.go#L52-L78
